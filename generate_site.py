...
for variant in ["v1", "v2", "v3", "v4", "v5", "v6"]:
    (root / variant / "index.html").write_text(
        wrap("titleIndex", "home", variant, "../", home_pages[variant], "../index.html"),
        encoding="utf-8",
    )
